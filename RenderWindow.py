...
if __name__ == "__main__":
    ...
    rotor = {'Hub Diameter': '30.000', 'X Twist (Rotor)': '50.000', 'Blade Thickness (Rotor)': '16',
             ...
             'Root Chord (Rotor)': '20', 'Num of Blade (Rotor)': '24', 'Tip Chord (Rotor)': '10.88'}
    common = {'Reaction (R)': '0.4', 'Mean Line Radius': '47.455', 'Flow (Phi)': '0.691', 'RPM': '30000',
              'Loading (Psi)': '0.482'}
    stator = {"Duct ID": 100, "Duct Length": 20, "Duct Thickness": 2, "Num of Blade (Stator)": 13,
              "Mount Can Length": 20, "Mount Can Dia": 20, "Mount Can Loc": 0, "Blade Thickness (Stator)": 16,
              "Root Chord (Stator)": 20, "Tip Chord (Stator)": 10.88, "X Twist (Stator)": 50, "Y Twist (Stator)": 0}
